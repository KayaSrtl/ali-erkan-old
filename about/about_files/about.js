...
$(window).scroll(function(event){
	...
	if (st > $('.container_1_image_part').offset().top - window_height && $('.container_1_image_part').offset().top + window_height > st)  {
		...
		$(".container_1s_image").css('transform', 'translate3d(0px, ' + ((st)*(150.0/($('.container_1s_image').offset().top))-150) + 'px, 0px)');
	...
	if (st > $('.container_2s_image').offset().top - window_height && $('.container_2s_image').offset().top + window_height > st)  {
